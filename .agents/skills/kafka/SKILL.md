---
name: kafka-plan
description: Contains the complete FlashSeat Kafka topics and event-driven architecture design. Use this skill whenever the user asks to implement, verify, or configure Kafka producers, consumers, brokers, or worker pipelines.
---

# Kafka Plan Skill (FlashSeat Messaging Blueprint)

When this skill is triggered or when you are working on the FlashSeat Kafka event system, strictly follow the topics, producers, consumers, and payloads defined below.
