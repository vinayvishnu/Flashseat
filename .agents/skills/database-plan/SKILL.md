---
name: database-plan
description: Contains the complete FlashSeat Database Schema and Seed Data plan. Use this skill whenever the user asks to implement, verify, or extract information about the MongoDB schemas or database initialization.
---

# Database Plan Skill (FlashSeat Schema Blueprint)

When this skill is triggered or when you are working on the FlashSeat MongoDB backend, strictly follow the database schemas below. This serves as the source of truth for all collections, documents, and data seeding strategies.
