# FlashSeat - Technology Stack Specifications

This document details the software, platforms, libraries, and frameworks used in the FlashSeat project, along with the engineering rationale for each choice.
