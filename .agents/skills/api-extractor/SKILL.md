---
name: api-extractor
description: Contains the complete FlashSeat  API architecture, endpoints, and workflows. Use this skill whenever the user asks to implement, verify, or extract information about the FlashSeat backend APIs.
---

# API Extractor Skill (FlashSeat Blueprint)

When this skill is triggered or when you are working on the FlashSeat backend, strictly follow the API specification below. It serves as your source of truth for all workflows, databases, Kafka topics, Redis locks, and WebSockets.
